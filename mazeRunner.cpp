...
enum States { ST_Main, ST_GetMaze, ST_SolveMaze, ST_Creators, ST_Exit };
    ...
    while (curState != ST_Exit) {
        ...
        if (curState == ST_Main) {
            ...
            if (maze.getMazeStructure() == nullptr) {
                ...
                difference =
                    maze.compareHeights(worldHeight, logicalX, logicalZ);
                    ...
                    if (hasBuilt) {
                        ...
                        if (mode == NORMAL_MODE) {
                            ...
                            player.teleportPlayer(
                                *(maze.getStart()) +
                                mcpp::Coordinate(
                                    maze.mazeGaps.at(maze.findClosestGapDist())
                                        .getWidthCoord(),
                                    ABOVE_GROUND_HEIGHT,
                                    maze.mazeGaps.at(maze.findClosestGapDist())
                                        .getLengthCoord()));
